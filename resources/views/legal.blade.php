...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <h1 class="text-6xl font-normal leading-normal mt-4 mb-2">
        Legal notices
    </h1>
    <div class="d-flex">
        <div>
            ...
            <h3 class="text-4xl font-normal leading-normal mt-0 mb-2">
            ...
            <p>
                Source code of this app is available on <a href="https://github.com/carsso/pcc-manager" class="underline hover:text-indigo-600" target="_blank"><i class="fab fa-github"></i> GitHub</a><br />
